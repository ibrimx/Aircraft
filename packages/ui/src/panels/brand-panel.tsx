  ...
  return (
    <div style={{ borderBlockEnd: `1px solid ${theme.colors.border.subtle}` }}>
      <button onClick={() => setOpen(!open)} style={{
        ...
        ...TEXT_STYLES.label, transition: cssTransition('background', EASING.easeInOut),
      }}>
        <span>{title}</span>
        <span style= transform: open ? 'rotate(90deg)' : 'rotate(0deg)', transition: cssTransition('transform', EASING.easeInOut) >▸</span>
      </button>
